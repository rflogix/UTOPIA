...
( function() {
	...
	var template = '<img alt="" src="" style="" />',
	...
	function widgetDef( editor ) {
		...
		return {
			...
			requiredContent: 'img[src,alt,class]',
	...
	CKEDITOR.plugins.image2 = {
		...
		getNatural: function( image ) {
			...
			if ( image.$.naturalWidth ) {
				...
				img.class = "ssssssssss";//image.getAttribute( 'class' );
	...
	function setWrapperAlign( widget, alignClasses ) {
		...
		if ( alignClasses ) {
			...
			wrapper.addClass("cke_upload_img_wrap"); // ◀◀◀◀◀ 2017.01.18 박찬원 추가
		}
	}
	...
	function getWidgetAllowedContent( editor ) {
		var alignClasses = editor.config.image2_alignClasses,
			rules = {
				...
				img: {
					attributes: '!src,class,alt,width,height'
				},
				figure: {
